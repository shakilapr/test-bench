...
Board: ESP32 DevKit V1 (Classic ESP32).

## Connections

| ESP32 pin | ADS1115 pin | Notes |
| --- | --- | --- |
| `3V3` | `VDD` | 3.3 V power |
| `GND` | `GND` | Common ground; also connect shunt reference ground here |
| `GPIO21` | `SDA` | I2C data (`Config::kI2cSdaPin`) |
| `GPIO22` | `SCL` | I2C clock (`Config::kI2cSclPin`) |
...
| ESP32 pin | Hall sensor pin | Notes |
| --- | --- | --- |
